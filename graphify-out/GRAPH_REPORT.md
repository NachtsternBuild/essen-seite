...
## Corpus Check
- 123 files · ~76,472 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 934 nodes · 1612 edges · 94 communities (47 shown, 47 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08c3e296`
...
5. `Essensplaner – Quickstart: Produktiv-Setup auf Ubuntu Server 26.04 LTS` - 19 edges
...
Cohesion: 0.06
Nodes (54): FormMode, GROUP_COLORS, GroupForm(), GroupCard(), GroupCardProps, GroupManagementProps, GROUP_COLORS, SystemSettingsForm() (+46 more)
...
Cohesion: 0.23
Nodes (12): formatTime(), NotificationBell(), TYPE_ICON, NotificationsPanel(), maybeShowDesktop(), useNotifications(), getPref(), setPref() (+4 more)
...
Cohesion: 0.08
Nodes (37): Dashboard(), focusWeek(), greeting(), GroupSummary(), HeroCard(), planHasMeals(), todayPlanDay(), WeekSummary() (+29 more)

### Community 7 - "Theme & Auth Context"
Cohesion: 0.12
Nodes (8): MaintenancePanel(), MaintenancePanelProps, BaseRepository, maintenanceService, SettingRecord, settings, MaintenanceInfo, MaintenanceSettings
...
Cohesion: 0.11
Nodes (25): useAuthContext(), GroupProvider(), PermissionContext, PermissionContextValue, PermissionProvider(), ToastContext, ToastContextValue, ToastProvider() (+17 more)
...
Cohesion: 0.11
Nodes (18): 10. HTTPS mit Let's Encrypt, 11. Firewall finalisieren, 12. Backups einrichten, 13. Updates & Wartung, 14. Fehlersuche, 15. Checkliste, 1. Grundabsicherung des Servers, 2. Benötigte Pakete installieren (+10 more)
...
Cohesion: 0.05
Nodes (70): AddMealForm(), AddMealFormProps, DashboardProps, GroupFormProps, GroupSelector(), GroupSelectorProps, MealCard, MealCardProps (+62 more)
...
Cohesion: 0.22
Nodes (12): AppearancePanel(), LABELS, NEXT, ThemeToggle(), applyAccent(), applyTheme(), getSystemTheme(), ThemeContext (+4 more)
...
Cohesion: 0.20
Nodes (10): 1. Was ist der Essensplaner?, 2. Anmelden & Abmelden, 3. Der Aufbau der Oberfläche, 5. Essen bestellen – Schritt für Schritt, 6. Der Bestellschluss (08:30-Regel), 8. Häufige Fragen (FAQ), Essensplaner – Benutzerhandbuch, Hauptbereich (rechts) (+2 more)
...
Cohesion: 0.06
Nodes (53): App(), GroupManagement(), LoginForm(), LoginFormProps, ACTION_ICON, formatTime(), PlanHistoryModal(), PlanHistoryModalProps (+45 more)

### Community 83 - "Community 83"
Cohesion: 0.22
Nodes (9): 4. Die Menüs im Detail, 📦 Archiv, ⚙️ Einstellungen, 🏢 Gruppen, 👥 Nutzer, 🗑 Papierkorb, 📅 Planung / 🗓 Aktuelle Woche, 📈 Statistiken (+1 more)
...
Cohesion: 0.33
Nodes (6): B.1 Adressierung – wie erreichen die Clients den Server?, B.2 nginx für den internen Zugriff, B.3 HTTPS im internen Netz – drei Optionen, B.4 Firewall im LAN, B.5 Zugriff & Superuser, Variante B: Lokales oder firmeninternes Netz (ohne Domain)
...
Cohesion: 0.40
Nodes (5): 7. Rollen & Rechte, 🛠 Administrator (Gruppenadministrator), 👤 Benutzer, 🛡 Superuser, Was bedeuten die einzelnen Rechte?
...
- **Why does `exportPDF()` connect `Meal Form & Cards` to `Package Dependencies`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `jspdf` connect `Package Dependencies` to `Meal Form & Cards`?**
